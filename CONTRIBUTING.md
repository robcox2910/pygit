...
```bash
# Clone the repo
git clone https://github.com/robcox2910/pygit.git
cd pygit
...
| Prefix | When to use |
|--------|-------------|
| `feat/` | New feature or version control component |
| `fix/` | Bug fix |
...
Example: `feat/branching`, `fix/commit-tree`
...
```
feat: add commit history traversal
fix: resolve blob hash collision
docs: add object store concept page
```
...
feat: adds branching   # not imperative mood ("adds" -> "add")
```
...
Open an issue on [GitHub](https://github.com/robcox2910/pygit/issues) --
we're happy to help!
